"""
==========================================================
MKL: A framework for Multiple Kernel Learning for Python
==========================================================

MKL is a framework for Multiple Kernel Learning and Kernel Learning for python
based on numpy, scikit-learn and cvxopt.

Contents
--------
The main contents of MKL are:
...
Subpackages
-----------
MKL is divided into subpackages, using any of these requires an explicit import.
